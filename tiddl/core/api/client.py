...
class TidalClientImproved:
    ...
    def __init__(
        ...
        # Rotate Chrome version per session to avoid fingerprinting
        _chrome_versions = [
            ("120", "120.0.6099.130"),
            ("122", "122.0.6261.112"),
            ("124", "124.0.6367.82"),
        ...
        _cv_short, _cv_full = random.choice(_chrome_versions)
        ...
        self.session.headers = {
            ...
            "User-Agent": f"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{_cv_full} Safari/537.36",
            "Origin": "https://listen.tidal.com",
            "Referer": "https://listen.tidal.com/",
            "sec-ch-ua": f'"Chromium";v="{_cv_short}", "Google Chrome";v="{_cv_short}", "Not-A.Brand";v="99"',
            "sec-ch-ua-mobile": "?0",
