...
from tiddl.core.utils.format import generate_template_data, format_template
...
class TestArtistSeparatorTemplates:
    ...
    def test_artists_with_features_slash(self):
        data = generate_template_data(item=self.ITEM, sep=" / ")
    ...
    def test_format_template_passes_separator(self):
        ...
        assert sig.parameters["artist_separator"].default == " / "
